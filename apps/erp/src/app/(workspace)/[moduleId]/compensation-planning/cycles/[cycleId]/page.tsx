...
import HrCompensationPlanningCycleDetailPage from "@/workspace-routes/hr-compensation-planning-cycle-detail.server";
export { metadata } from "@/workspace-routes/hr-compensation-planning-cycle-detail.server";
