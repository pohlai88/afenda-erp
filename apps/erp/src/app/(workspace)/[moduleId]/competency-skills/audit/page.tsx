...
import HrCompetencySkillsAuditPage from "@/workspace-routes/hr-competency-skills-audit.server";
export { metadata } from "@/workspace-routes/hr-competency-skills-audit.server";
