...
import HrCompetencySkillsReportsPage from "@/workspace-routes/hr-competency-skills-reports.server";
export { metadata } from "@/workspace-routes/hr-competency-skills-reports.server";
