...
import { createApiCredentialFormAction } from "@/app/(app)/system-admin/integrations/actions";
...
export function CreateApiCredentialForm() {
  const [selectedScopes, setSelectedScopes] = useState<string[]>(defaultApiScopes);
