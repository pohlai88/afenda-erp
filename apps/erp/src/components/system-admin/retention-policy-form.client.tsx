...
import { upsertRetentionPolicyAction } from "@/app/(app)/system-admin/audit/actions";
    ...
    <form action={formAction} className="grid max-w-xl gap-4 sm:grid-cols-2">
      <label className="flex flex-col gap-1 text-sm sm:col-span-2">
        ...
        >
          ...
          <NativeSelectOption value="user-profile">user-profile</NativeSelectOption>
          <NativeSelectOption value="erp-record">erp-record</NativeSelectOption>
          <NativeSelectOption value="workflow-item">workflow-item</NativeSelectOption>
