/**
 * Module section catch-all (system-admin, hr). Slug -> app adapter -> feature package.
 */
import {
...
} from "@/section-adapters/hr/registry.server";
...
} from "@/section-adapters/system-admin/registry.server";
import {
