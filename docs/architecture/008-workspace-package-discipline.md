...
| ------------------ | --------------------------------- | ------------------------------------------------------------------------------- |
| Deployable app     | `apps/erp`                        | App Router routes, layouts, handlers, workspace composition                     |
...
| ----------------- | ---------------------------------------------------------------------------------- |
| `apps/erp`        | Imports public doors from feature, kernel, platform, and UI packages              |
