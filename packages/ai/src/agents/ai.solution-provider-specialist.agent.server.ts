...
import { getSolutionProviderSystemPrompt } from "../prompts/ai.system-prompt";
...
/**
 * Backward-compatible export for the deprecated /api/ai/solution-provider
 * shim. New code should use createSolutionProviderSpecialistAgent.
 *
 * @deprecated Use createSolutionProviderSpecialistAgent.
 */
export const createSolutionProviderAgent =
