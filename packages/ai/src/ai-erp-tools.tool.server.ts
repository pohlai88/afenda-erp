...
import type { ModuleWorkspaceStats } from "@afenda/kernel";
import { tool } from "ai";
import { assertCapabilityAllowed } from "./ai-guardrails.policy";
import {
  approveActionSandbox,
  createActionSandbox,
} from "./ai-sandbox.action.server";
import type { ActionSandbox } from "./ai-operations.schema";
import {
...
import type { ApprovalProposalToolInput } from "./ai-tools.contract";
