...
import { APP_SHELL_UTILITY_DROPDOWN_CONTENT_WIDE_CLASS, APP_SHELL_UTILITY_L2_MENU_TRIGGER_OPEN_STATE_CLASS } from "./app-utility-dropdown-chrome-shared";
import { APP_SHELL_UTILITY_ICON_BUTTON_SM_CLASS } from "./app-utility-chrome-shared";
