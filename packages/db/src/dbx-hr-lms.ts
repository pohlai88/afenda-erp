...
export const hrLmsCourses = pgTable("hr_lms_courses", {
    ...
    uniqueIndex("hr_lms_courses_org_code_uidx").on(table.organizationId, table.code),
    index("hr_lms_courses_org_status_idx").on(table.organizationId, table.courseStatus),
    index("hr_lms_courses_org_type_idx").on(table.organizationId, table.courseType),
]);
/** LMS-004/005 — internal/external/SCORM/xAPI content references. */
export const hrLmsCourseContentRefs = pgTable("hr_lms_course_content_refs", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    index("hr_lms_course_content_refs_org_course_idx").on(table.organizationId, table.courseId),
]);
/** LMS-006/007 — structured learning paths. */
export const hrLmsLearningPaths = pgTable("hr_lms_learning_paths", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    code: text("code").notNull(),
    ...
    targetDepartmentId: text("target_department_id").references(() => hrDepartments.id, { onDelete: "set null" }),
    ...
    uniqueIndex("hr_lms_learning_paths_org_code_uidx").on(table.organizationId, table.code),
    index("hr_lms_learning_paths_org_kind_idx").on(table.organizationId, table.pathKind),
]);
export const hrLmsLearningPathCourses = pgTable("hr_lms_learning_path_courses", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    pathId: text("path_id")
        .notNull()
    ...
    uniqueIndex("hr_lms_learning_path_courses_org_path_order_uidx").on(table.organizationId, table.pathId, table.sequenceOrder),
    index("hr_lms_learning_path_courses_org_path_idx").on(table.organizationId, table.pathId),
]);
/** LMS-008/009/020 — course or path assignments. */
export const hrLmsAssignments = pgTable("hr_lms_assignments", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    index("hr_lms_assignments_org_employee_idx").on(table.organizationId, table.employeeId),
    index("hr_lms_assignments_org_course_idx").on(table.organizationId, table.courseId),
    index("hr_lms_assignments_org_compliance_idx").on(table.organizationId, table.isComplianceMandatory),
]);
/** LMS-010/011 — enrollments including self-enroll and approval. */
export const hrLmsEnrollments = pgTable("hr_lms_enrollments", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    employeeId: text("employee_id")
        .notNull()
    ...
    uniqueIndex("hr_lms_enrollments_org_employee_course_uidx").on(table.organizationId, table.employeeId, table.courseId),
    index("hr_lms_enrollments_org_status_idx").on(table.organizationId, table.enrollmentStatus),
]);
/** LMS-012/013 — progress tracking. */
export const hrLmsProgress = pgTable("hr_lms_progress", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    uniqueIndex("hr_lms_progress_org_enrollment_uidx").on(table.organizationId, table.enrollmentId),
    index("hr_lms_progress_org_employee_status_idx").on(table.organizationId, table.employeeId, table.progressStatus),
]);
/** LMS-014/015/016 — assessment attempts. */
export const hrLmsAssessmentAttempts = pgTable("hr_lms_assessment_attempts", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    enrollmentId: text("enrollment_id")
        .notNull()
    ...
    index("hr_lms_assessment_attempts_org_enrollment_idx").on(table.organizationId, table.enrollmentId),
    uniqueIndex("hr_lms_assessment_attempts_org_enrollment_attempt_uidx").on(table.organizationId, table.enrollmentId, table.attemptNumber),
]);
/** LMS-017/018 — certification records. */
export const hrLmsCertifications = pgTable("hr_lms_certifications", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    employeeId: text("employee_id")
        .notNull()
    ...
    index("hr_lms_certifications_org_employee_idx").on(table.organizationId, table.employeeId),
    index("hr_lms_certifications_org_status_idx").on(table.organizationId, table.certificationStatus),
]);
/** LMS-019 — reminders. */
export const hrLmsReminders = pgTable("hr_lms_reminders", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    employeeId: text("employee_id")
        .notNull()
    ...
    certificationId: text("certification_id").references(() => hrLmsCertifications.id, { onDelete: "cascade" }),
    ...
    index("hr_lms_reminders_org_employee_kind_idx").on(table.organizationId, table.employeeId, table.reminderKind),
]);
/** LMS-030 — audit trail. */
export const hrLmsAuditEvents = pgTable("hr_lms_audit_events", {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    index("hr_lms_audit_events_org_occurred_idx").on(table.organizationId, table.occurredAt),
    index("hr_lms_audit_events_org_action_idx").on(table.organizationId, table.action),
]);
