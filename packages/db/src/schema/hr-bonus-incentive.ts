...
export const hrBonusPayoutFormulaKindEnum = pgEnum(
  "hr_bonus_payout_formula_kind",
  [
    "fixed_amount",
    "salary_percentage",
    "sales_percentage",
...
export const hrBonusPlanParticipantStatusEnum = pgEnum(
  "hr_bonus_plan_participant_status",
  ["assigned", "excluded", "pending_review"],
);

/** BON-001 — bonus and incentive plan catalog. */
export const hrBonusPlans = pgTable(
  "hr_bonus_plans",
  {
    ...
    approvalRoutingConfig: jsonb("approval_routing_config").$type<
      HrBonusApprovalRoutingConfig | null
    >(),
  ...
  (table) => [
    uniqueIndex("hr_bonus_plans_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_bonus_plans_org_status_idx").on(
      table.organizationId,
      table.planStatus,
    ),
    index("hr_bonus_plans_org_effective_idx").on(
      table.organizationId,
      table.effectiveFrom,
      table.effectiveTo,
    ),
...
export const hrBonusEligibilityRules = pgTable(
  "hr_bonus_eligibility_rules",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    index("hr_bonus_eligibility_rules_org_plan_idx").on(
      table.organizationId,
      table.planId,
      table.active,
    ),
    index("hr_bonus_eligibility_rules_org_scope_idx").on(
      table.organizationId,
...
export const hrBonusPlanParticipants = pgTable(
  "hr_bonus_plan_participants",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    uniqueIndex("hr_bonus_plan_participants_org_plan_employee_uidx").on(
      table.organizationId,
      table.planId,
      table.employeeId,
    ),
    index("hr_bonus_plan_participants_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hr_bonus_plan_participants_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrBonusCycles = pgTable(
  "hr_bonus_cycles",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_bonus_cycles_org_plan_code_uidx").on(
      table.organizationId,
      table.planId,
      table.code,
    ),
    index("hr_bonus_cycles_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hr_bonus_cycles_org_status_idx").on(
      table.organizationId,
      table.cycleStatus,
    ),
  ],
...
export const hrBonusTargets = pgTable(
  "hr_bonus_targets",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_bonus_targets_org_cycle_kind_scope_uidx").on(
      table.organizationId,
      table.cycleId,
      table.targetKind,
      table.scopeKey,
    ),
    index("hr_bonus_targets_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hr_bonus_targets_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrBonusTargetAchievements = pgTable(
  "hr_bonus_target_achievements",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_bonus_target_achievements_org_target_uidx").on(
      table.organizationId,
      table.targetId,
    ),
    index("hr_bonus_target_achievements_org_recorded_idx").on(
      table.organizationId,
      table.recordedAt,
    ),
  ],
...
export const hrBonusPayoutFormulas = pgTable(
  "hr_bonus_payout_formulas",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    uniqueIndex("hr_bonus_payout_formulas_org_plan_uidx").on(
      table.organizationId,
      table.planId,
    ),
  ],
...
export const hrBonusCommissionTiers = pgTable(
  "hr_bonus_commission_tiers",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    index("hr_bonus_commission_tiers_org_plan_order_idx").on(
      table.organizationId,
      table.planId,
      table.tierOrder,
    ),
...
export const hrBonusAcceleratorRules = pgTable(
  "hr_bonus_accelerator_rules",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    uniqueIndex("hr_bonus_accelerator_rules_org_plan_uidx").on(
      table.organizationId,
      table.planId,
    ),
  ],
...
export const hrBonusAuditEvents = pgTable(
  "hr_bonus_audit_events",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    achievementId: text("achievement_id").references(
      () => hrBonusTargetAchievements.id,
      { onDelete: "set null" },
    ),
    employeeId: text("employee_id").references(() => hrEmployees.id, {
      onDelete: "set null",
  ...
  (table) => [
    index("hr_bonus_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_bonus_audit_events_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
  ],
...
export const hrBonusRecommendationStatusEnum = pgEnum(
  "hr_bonus_recommendation_status",
  ["draft", "submitted", "approved", "rejected"],
);

/** BON-013 — guaranteed bonus rules per plan. */
export const hrBonusGuaranteedRules = pgTable(
  "hr_bonus_guaranteed_rules",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    index("hr_bonus_guaranteed_rules_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hr_bonus_guaranteed_rules_org_active_idx").on(
      table.organizationId,
      table.active,
    ),
  ],
...
export const hrBonusPerformanceMultipliers = pgTable(
  "hr_bonus_performance_multipliers",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    index("hr_bonus_multipliers_org_plan_scope_idx").on(
      table.organizationId,
      table.planId,
      table.scope,
    ),
...
export const hrBonusProrations = pgTable(
  "hr_bonus_prorations",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_bonus_prorations_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_bonus_prorations_org_plan_cycle_idx").on(
      table.organizationId,
      table.planId,
      table.cycleId,
    ),
...
export const hrBonusManualAdjustments = pgTable(
  "hr_bonus_manual_adjustments",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id")
  ...
  (table) => [
    index("hr_bonus_manual_adjustments_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_bonus_manual_adjustments_org_status_idx").on(
      table.organizationId,
      table.status,
    ),
  ],
...
export const hrBonusDiscretionaryRecommendations = pgTable(
  "hr_bonus_discretionary_recommendations",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    planId: text("plan_id").references(() => hrBonusPlans.id, {
    ...
    currencyCode: text("currency_code").notNull().default("USD"),
    recommendationStatus: hrBonusRecommendationStatusEnum(
  ...
  (table) => [
    index("hr_bonus_recommendations_org_status_idx").on(
      table.organizationId,
      table.recommendationStatus,
    ),
    index("hr_bonus_recommendations_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrBonusRecoveries = pgTable(
  "hr_bonus_recoveries",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_bonus_recoveries_org_kind_idx").on(
      table.organizationId,
      table.recoveryKind,
    ),
    index("hr_bonus_recoveries_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
