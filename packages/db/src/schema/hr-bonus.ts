...
export { hrBonusPlanTypeEnum, hrBonusPlans, hrBonusCycles };
...
export const hrBonusPayouts = pgTable(
  "hr_bonus_payouts",
  {
  ...
  (table) => [
    index("hr_bonus_payouts_org_status_idx").on(
      table.organizationId,
      table.payoutStatus,
    ),
    index("hr_bonus_payouts_org_plan_cycle_idx").on(
      table.organizationId,
      table.planId,
      table.cycleId,
    ),
    index("hr_bonus_payouts_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_bonus_payouts_org_locked_idx").on(
      table.organizationId,
      table.lockedAt,
    ),
  ],
...
export const hrBonusPayoutApprovalSteps = pgTable(
  "hr_bonus_payout_approval_steps",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_bonus_payout_approval_steps_org_payout_idx").on(
      table.organizationId,
      table.payoutId,
      table.stepOrder,
    ),
...
export const hrBonusPayrollPayoutReferences = pgTable(
  "hr_bonus_payroll_payout_references",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    payoutId: text("payout_id")
  ...
  (table) => [
    uniqueIndex("hr_bonus_payroll_refs_org_payroll_ref_uidx").on(
      table.organizationId,
      table.payrollPayoutReference,
    ),
    index("hr_bonus_payroll_refs_org_payout_idx").on(
      table.organizationId,
      table.payoutId,
    ),
    index("hr_bonus_payroll_refs_org_active_idx").on(
      table.organizationId,
      table.active,
    ),
  ],
...
export const hrBonusPayoutAuditEvents = pgTable(
  "hr_bonus_payout_audit_events",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_bonus_payout_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_bonus_payout_audit_events_org_payout_idx").on(
      table.organizationId,
      table.payoutId,
    ),
    index("hr_bonus_payout_audit_events_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_bonus_payout_audit_events_org_action_idx").on(
      table.organizationId,
      table.action,
    ),
  ],
