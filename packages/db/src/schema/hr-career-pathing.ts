...
import { erpPriorityEnum, organizationIdColumn, timestampColumns } from "./common";
...
export const hrCareerPathFrameworkStatusEnum = pgEnum(
  "hr_career_path_framework_status",
...
export const hrDevelopmentMilestoneStatusEnum = pgEnum(
  "hr_development_milestone_status",
  ["not_started", "in_progress", "completed", "overdue", "cancelled"],
);

export const hrDevelopmentLearningActionStatusEnum = pgEnum(
  "hr_development_learning_action_status",
  ["planned", "in_progress", "completed", "cancelled"],
);

export const hrDevelopmentStretchAssignmentKindEnum = pgEnum(
  "hr_development_stretch_assignment_kind",
  ["project", "acting_role", "cross_functional", "leadership_exposure"],
);

export const hrDevelopmentStretchAssignmentStatusEnum = pgEnum(
  "hr_development_stretch_assignment_status",
  ["planned", "active", "completed", "cancelled"],
);

export const hrDevelopmentMentorCoachStatusEnum = pgEnum(
  "hr_development_mentor_coach_status",
...
export const hrEmployeeTargetRoleSourceEnum = pgEnum(
  "hr_employee_target_role_source",
  ["employee", "manager", "hr"],
);
...
export const hrmCareerPathFrameworks = pgTable(
  ...
  (table) => [
    ...
    index("hrm_career_path_framework_org_path_kind_idx").on(
      table.organizationId,
      table.pathKind,
    ),
  ],
...
export const hrmCareerPathStages = pgTable(
  ...
  (table) => [
    uniqueIndex("hrm_career_path_stage_org_framework_code_uidx").on(
      table.organizationId,
      table.frameworkId,
      table.code,
    ),
    uniqueIndex("hrm_career_path_stage_org_framework_order_uidx").on(
      table.organizationId,
      table.frameworkId,
      table.stageOrder,
    ),
...
export const hrmEmployeeCareerAspirations = pgTable(
  "hrm_employee_career_aspiration",
  {
    ...
    preferredDepartmentId: text("preferred_department_id").references(
      () => hrDepartments.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    uniqueIndex("hrm_employee_career_aspiration_org_employee_uidx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_employee_career_aspiration_org_dept_idx").on(
      table.organizationId,
      table.preferredDepartmentId,
    ),
  ],
);

/** HRM-CAR-004/005 — employee target role with org-structure refs. */
export const hrmEmployeeTargetRoles = pgTable(
  ...
  (table) => [
    uniqueIndex("hrm_employee_target_role_org_employee_uidx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_employee_target_role_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_employee_target_role_org_dept_idx").on(
      table.organizationId,
      table.departmentId,
    ),
    index("hrm_employee_target_role_org_job_family_idx").on(
      table.organizationId,
      table.jobFamily,
    ),
  ],
...
export const hrmDevelopmentPlans = pgTable(
  ...
  (table) => [
    uniqueIndex("hrm_development_plan_org_employee_code_uidx").on(
      table.organizationId,
      table.employeeId,
      table.code,
    ),
    index("hrm_development_plan_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_development_plan_org_status_idx").on(
      table.organizationId,
      table.planStatus,
    ),
    index("hrm_development_plan_org_target_role_idx").on(
      table.organizationId,
      table.targetRoleId,
    ),
  ],
...
export const hrmDevelopmentGoals = pgTable(
  ...
  (table) => [
    ...
    index("hrm_development_goal_org_plan_status_idx").on(
      table.organizationId,
      table.planId,
      table.goalStatus,
    ),
    index("hrm_development_goal_org_plan_type_idx").on(
      table.organizationId,
      table.planId,
      table.goalType,
    ),
...
export const hrmDevelopmentMilestones = pgTable(
  ...
  (table) => [
    index("hrm_development_milestone_org_goal_idx").on(
      table.organizationId,
      table.goalId,
    ),
    index("hrm_development_milestone_org_goal_target_date_idx").on(
      table.organizationId,
      table.goalId,
      table.targetDate,
    ),
    index("hrm_development_milestone_org_status_target_date_idx").on(
      table.organizationId,
...
export const hrmDevelopmentLearningActions = pgTable(
  "hrm_development_learning_action",
  {
    ...
    learningActionStatus: hrDevelopmentLearningActionStatusEnum(
  ...
  (table) => [
    index("hrm_development_learning_action_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hrm_development_learning_action_org_course_idx").on(
      table.organizationId,
      table.trainingCourseId,
    ),
  ],
);

/** HRM-CAR-018 — stretch / project / acting-role exposure. */
export const hrmDevelopmentStretchAssignments = pgTable(
  ...
  (table) => [
    index("hrm_development_stretch_assignment_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hrm_development_stretch_assignment_org_status_idx").on(
      table.organizationId,
...
export const hrmDevelopmentMentorAssignments = pgTable(
  ...
  (table) => [
    uniqueIndex("hrm_development_mentor_assignment_org_plan_uidx").on(
      table.organizationId,
      table.planId,
    ),
    index("hrm_development_mentor_assignment_org_mentor_idx").on(
      table.organizationId,
      table.mentorEmployeeId,
    ),
  ],
);

/** HRM-CAR-016 — coach per development plan. */
export const hrmDevelopmentCoachAssignments = pgTable(
  ...
  (table) => [
    uniqueIndex("hrm_development_coach_assignment_org_plan_uidx").on(
      table.organizationId,
      table.planId,
    ),
    index("hrm_development_coach_assignment_org_coach_idx").on(
      table.organizationId,
      table.coachEmployeeId,
    ),
  ],
);

/** HRM-CAR-017 — mentor or coach session log. */
export const hrmDevelopmentSessions = pgTable(
  "hrm_development_session",
  {
    ...
    mentorAssignmentId: text("mentor_assignment_id").references(
      () => hrmDevelopmentMentorAssignments.id,
      { onDelete: "set null" },
    ),
    coachAssignmentId: text("coach_assignment_id").references(
      () => hrmDevelopmentCoachAssignments.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    index("hrm_development_session_org_plan_idx").on(
      table.organizationId,
      table.planId,
    ),
    index("hrm_development_session_org_plan_date_idx").on(
      table.organizationId,
      table.planId,
      table.sessionDate,
    ),
...
export const hrmCareerDiscussions = pgTable(
  ...
  (table) => [
    index("hrm_career_discussion_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_career_discussion_org_employee_date_idx").on(
      table.organizationId,
      table.employeeId,
      table.discussionDate,
    ),
    index("hrm_career_discussion_org_next_review_idx").on(
      table.organizationId,
...
export const hrmEmployeeReadinessSnapshots = pgTable(
  ...
  (table) => [
    index("hrm_employee_readiness_snapshot_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hrm_employee_readiness_snapshot_org_employee_computed_idx").on(
      table.organizationId,
      table.employeeId,
      table.computedAt,
    ),
    index("hrm_employee_readiness_snapshot_org_level_idx").on(
      table.organizationId,
      table.readinessLevel,
    ),
  ],
);
