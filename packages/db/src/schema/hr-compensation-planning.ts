...
export const hrCompensationCycleStatusEnum = pgEnum(
  "hr_compensation_cycle_status",
  ["draft", "planning", "in_review", "approved", "closed", "cancelled"],
);

/** CPM-003 — budget pool scope dimensions. */
export const hrCompensationBudgetPoolScopeEnum = pgEnum(
  "hr_compensation_budget_pool_scope",
  [
    "organization",
    "legal_entity",
    "department",
...
export const hrCompensationParticipantEligibilityEnum = pgEnum(
  "hr_compensation_participant_eligibility",
  ["eligible", "ineligible", "exception"],
);

/** CPM-008..012 — adjustment recommendation kinds. */
export const hrCompensationAdjustmentTypeEnum = pgEnum(
  "hr_compensation_adjustment_type",
  [
    "merit",
    "promotion",
    "market",
...
export const hrCompensationRecommendationStatusEnum = pgEnum(
  "hr_compensation_recommendation_status",
  [
    "draft",
    "submitted",
    "hr_review",
...
export const hrCompensationScenarioStatusEnum = pgEnum(
  "hr_compensation_scenario_status",
  ["draft", "active", "superseded", "archived"],
);

export const hrCompensationPayrollSyncStatusEnum = pgEnum(
  "hr_compensation_payroll_sync_status",
...
export const hrCompensationCycles = pgTable(
  "hr_compensation_cycles",
  {
  ...
  (table) => [
    uniqueIndex("hr_compensation_cycles_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_compensation_cycles_org_status_idx").on(
      table.organizationId,
      table.cycleStatus,
    ),
  ],
...
export const hrCompensationBudgetPools = pgTable(
  "hr_compensation_budget_pools",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_compensation_budget_pools_org_cycle_code_uidx").on(
      table.organizationId,
      table.cycleId,
      table.code,
    ),
    index("hr_compensation_budget_pools_org_scope_idx").on(
      table.organizationId,
      table.scope,
      table.scopeRef,
    ),
...
export const hrCompensationEligibilityRules = pgTable(
  "hr_compensation_eligibility_rules",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    cycleId: text("cycle_id")
  ...
  (table) => [
    index("hr_compensation_eligibility_rules_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
  ],
...
export const hrCompensationCycleParticipants = pgTable(
  "hr_compensation_cycle_participants",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    cycleId: text("cycle_id")
    ...
    budgetPoolId: text("budget_pool_id").references(
      () => hrCompensationBudgetPools.id,
      { onDelete: "set null" },
    ),
    eligibilityStatus: hrCompensationParticipantEligibilityEnum(
      "eligibility_status",
    )
      .notNull()
      .default("eligible"),
  ...
  (table) => [
    uniqueIndex("hr_compensation_participants_org_cycle_employee_uidx").on(
      table.organizationId,
      table.cycleId,
      table.employeeId,
    ),
    index("hr_compensation_participants_org_eligibility_idx").on(
      table.organizationId,
...
export const hrCompensationSalaryBands = pgTable(
  "hr_compensation_salary_bands",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_compensation_salary_bands_org_grade_entity_uidx").on(
      table.organizationId,
      table.grade,
...
export const hrCompensationRecommendations = pgTable(
  "hr_compensation_recommendations",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    cycleId: text("cycle_id")
    ...
    recommendationStatus: hrCompensationRecommendationStatusEnum(
  ...
  (table) => [
    index("hr_compensation_recommendations_org_cycle_status_idx").on(
      table.organizationId,
      table.cycleId,
      table.recommendationStatus,
    ),
    index("hr_compensation_recommendations_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrCompensationScenarios = pgTable(
  "hr_compensation_scenarios",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    cycleId: text("cycle_id")
  ...
  (table) => [
    index("hr_compensation_scenarios_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
  ],
...
export const hrCompensationApprovalSteps = pgTable(
  "hr_compensation_approval_steps",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_compensation_approval_steps_org_recommendation_idx").on(
      table.organizationId,
...
export const hrCompensationSalaryChanges = pgTable(
  "hr_compensation_salary_changes",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    cycleId: text("cycle_id")
  ...
  (table) => [
    uniqueIndex("hr_compensation_salary_changes_org_recommendation_uidx").on(
      table.organizationId,
      table.recommendationId,
    ),
    index("hr_compensation_salary_changes_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrCompensationPayrollRefs = pgTable(
  ...
  (table) => [
    uniqueIndex("hr_compensation_payroll_refs_org_salary_change_uidx").on(
      table.organizationId,
      table.salaryChangeId,
    ),
    index("hr_compensation_payroll_refs_org_sync_status_idx").on(
      table.organizationId,
      table.syncStatus,
    ),
  ],
...
/** CPM-030 — audit trail. */
export const hrCompensationAuditEvents = pgTable(
  ...
  (table) => [
    index("hr_compensation_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_compensation_audit_events_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
  ],
