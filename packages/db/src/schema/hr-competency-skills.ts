...
export const hrCsfSkillRequirementClassEnum = pgEnum(
  "hr_csf_skill_requirement_class",
  ["mandatory", "preferred", "critical", "optional"],
);

/** CSF-005/006 — reusable proficiency scale definitions. */
export const hrCsfProficiencyScales = pgTable(
  "hr_csf_proficiency_scales",
  {
  ...
  (table) => [
    uniqueIndex("hr_csf_proficiency_scales_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_csf_proficiency_scales_org_status_idx").on(
      table.organizationId,
      table.scaleStatus,
    ),
  ],
...
export const hrCsfProficiencyLevels = pgTable(
  "hr_csf_proficiency_levels",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_proficiency_levels_org_scale_order_uidx").on(
      table.organizationId,
      table.scaleId,
      table.levelOrder,
    ),
    uniqueIndex("hr_csf_proficiency_levels_org_scale_code_uidx").on(
      table.organizationId,
      table.scaleId,
      table.code,
    ),
    index("hr_csf_proficiency_levels_org_scale_idx").on(
      table.organizationId,
      table.scaleId,
    ),
  ],
...
export const hrCsfCompetencies = pgTable(
  "hr_csf_competencies",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_competencies_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_csf_competencies_org_category_idx").on(
      table.organizationId,
      table.category,
    ),
    index("hr_csf_competencies_org_status_idx").on(
      table.organizationId,
      table.libraryStatus,
    ),
  ],
...
export const hrCsfSkills = pgTable(
  "hr_csf_skills",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_skills_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_csf_skills_org_category_idx").on(
      table.organizationId,
      table.category,
    ),
    index("hr_csf_skills_org_status_idx").on(
      table.organizationId,
      table.libraryStatus,
    ),
  ],
...
export const hrCsfCompetencyRequirements = pgTable(
  "hr_csf_competency_requirements",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_competency_req_org_comp_scope_uidx").on(
      table.organizationId,
      table.competencyId,
      table.scope,
      table.scopeRef,
    ),
    index("hr_csf_competency_req_org_scope_idx").on(
      table.organizationId,
      table.scope,
      table.scopeRef,
    ),
...
export const hrCsfSkillRequirements = pgTable(
  "hr_csf_skill_requirements",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_skill_req_org_skill_scope_uidx").on(
      table.organizationId,
      table.skillId,
      table.scope,
      table.scopeRef,
    ),
    index("hr_csf_skill_req_org_scope_idx").on(
      table.organizationId,
      table.scope,
      table.scopeRef,
    ),
    index("hr_csf_skill_req_org_class_idx").on(
      table.organizationId,
      table.requirementClass,
    ),
  ],
);
...
export const hrCsfEmployeeCompetencyProfiles = pgTable(
  "hr_csf_employee_competency_profiles",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    competencyId: text("competency_id")
      .notNull()
      .references(() => hrCsfCompetencies.id, { onDelete: "cascade" }),
    currentProficiencyLevelId: text("current_proficiency_level_id").references(
  ...
  (table) => [
    uniqueIndex("hr_csf_emp_comp_profiles_org_emp_comp_uidx").on(
      table.organizationId,
      table.employeeId,
      table.competencyId,
    ),
    index("hr_csf_emp_comp_profiles_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_csf_emp_comp_profiles_org_competency_idx").on(
      table.organizationId,
      table.competencyId,
    ),
  ],
...
export const hrCsfEmployeeSkillProfiles = pgTable(
  "hr_csf_employee_skill_profiles",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    employeeId: text("employee_id")
  ...
  (table) => [
    uniqueIndex("hr_csf_emp_skill_profiles_org_emp_skill_uidx").on(
      table.organizationId,
      table.employeeId,
      table.skillId,
    ),
    index("hr_csf_emp_skill_profiles_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_csf_emp_skill_profiles_org_skill_idx").on(
      table.organizationId,
      table.skillId,
    ),
  ],
...
export const hrCsfAssessments = pgTable(
  "hr_csf_assessments",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    competencyProfileId: text("competency_profile_id").references(
      () => hrCsfEmployeeCompetencyProfiles.id,
      { onDelete: "set null" },
    ),
    skillProfileId: text("skill_profile_id").references(
      () => hrCsfEmployeeSkillProfiles.id,
      { onDelete: "set null" },
    ),
    ...
    assessorEmployeeId: text("assessor_employee_id").references(
      () => hrEmployees.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    index("hr_csf_assessments_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_csf_assessments_org_type_idx").on(
      table.organizationId,
      table.assessmentType,
    ),
    index("hr_csf_assessments_org_comp_profile_idx").on(
      table.organizationId,
      table.competencyProfileId,
    ),
    index("hr_csf_assessments_org_skill_profile_idx").on(
      table.organizationId,
      table.skillProfileId,
    ),
  ],
);

/** CSF-017 — assessment evidence rows. */
export const hrCsfAssessmentEvidence = pgTable(
  "hr_csf_assessment_evidence",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_csf_assessment_evidence_org_assessment_idx").on(
      table.organizationId,
      table.assessmentId,
    ),
  ],
...
export const hrCsfDevelopmentActionTypeEnum = pgEnum(
  "hr_csf_development_action_type",
  [
    "training",
    "coaching",
    "mentoring",
...
export const hrCsfDevelopmentRecommendationStatusEnum = pgEnum(
  "hr_csf_development_recommendation_status",
  ["recommended", "accepted", "in_progress", "completed", "dismissed"],
);

/** CSF-022 — linkage target kinds. */
export const hrCsfDevelopmentLinkTypeEnum = pgEnum(
  "hr_csf_development_link_type",
  [
    "course",
    "learning_path",
    "certification",
...
export const hrCsfGaps = pgTable(
  "hr_csf_gaps",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_csf_gaps_org_employee_req_uidx").on(
      table.organizationId,
      table.employeeId,
      table.gapKind,
      table.requirementId,
    ),
    index("hr_csf_gaps_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_csf_gaps_org_skill_idx").on(table.organizationId, table.skillId),
    index("hr_csf_gaps_org_competency_idx").on(
      table.organizationId,
      table.competencyId,
    ),
    index("hr_csf_gaps_org_status_idx").on(
      table.organizationId,
      table.gapStatus,
    ),
  ],
...
export const hrCsfGapClassifications = pgTable(
  "hr_csf_gap_classifications",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    gapId: text("gap_id")
    ...
    developmentUrgency: hrCsfDevelopmentUrgencyEnum(
      "development_urgency",
    ).notNull(),
  ...
  (table) => [
    uniqueIndex("hr_csf_gap_classifications_org_gap_uidx").on(
      table.organizationId,
      table.gapId,
    ),
    index("hr_csf_gap_classifications_org_severity_idx").on(
      table.organizationId,
      table.severity,
    ),
    index("hr_csf_gap_classifications_org_priority_idx").on(
      table.organizationId,
      table.priority,
    ),
  ],
...
export const hrCsfDevelopmentRecommendations = pgTable(
  "hr_csf_development_recommendations",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    gapId: text("gap_id")
    ...
    description: text("description"),
    priority: hrCsfGapPriorityEnum("priority").notNull(),
    recommendationStatus: hrCsfDevelopmentRecommendationStatusEnum(
  ...
  (table) => [
    ...
    index("hr_csf_dev_recs_org_status_idx").on(
      table.organizationId,
      table.recommendationStatus,
    ),
    index("hr_csf_dev_recs_org_action_idx").on(
      table.organizationId,
      table.actionType,
    ),
  ],
...
export const hrCsfDevelopmentLinks = pgTable(
  "hr_csf_development_links",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_csf_dev_links_org_rec_idx").on(
      table.organizationId,
      table.recommendationId,
    ),
    index("hr_csf_dev_links_org_type_idx").on(
      table.organizationId,
      table.linkType,
    ),
    uniqueIndex("hr_csf_dev_links_org_rec_ref_uidx").on(
      table.organizationId,
      table.recommendationId,
      table.linkType,
      table.externalRef,
...
export const hrCsfAuditEvents = pgTable(
  "hr_csf_audit_events",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    proficiencyScaleId: text("proficiency_scale_id").references(
      () => hrCsfProficiencyScales.id,
      { onDelete: "set null" },
    ),
  ...
  (table) => [
    index("hr_csf_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_csf_audit_events_org_competency_idx").on(
      table.organizationId,
      table.competencyId,
    ),
    index("hr_csf_audit_events_org_skill_idx").on(
      table.organizationId,
      table.skillId,
    ),
  ],
