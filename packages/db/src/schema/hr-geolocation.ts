...
export const hrGeoPolicyGroups = pgTable(
  "hr_geo_policy_groups",
  {
  ...
  (table) => [
    uniqueIndex("hr_geo_policy_groups_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_geo_policy_groups_org_active_idx").on(
      table.organizationId,
      table.active,
    ),
  ],
...
export const hrGeoGeofences = pgTable(
  "hr_geo_geofences",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_geo_geofences_org_group_idx").on(
      table.organizationId,
      table.policyGroupCode,
    ),
    index("hr_geo_geofences_org_kind_idx").on(
      table.organizationId,
      table.geofenceKind,
    ),
    index("hr_geo_geofences_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrGeoCheckinPolicies = pgTable(
  "hr_geo_checkin_policies",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    policyGroupCode: text("policy_group_code").notNull().default("default"),
  ...
  (table) => [
    uniqueIndex("hr_geo_checkin_policies_org_group_uidx").on(
      table.organizationId,
      table.policyGroupCode,
    ),
  ],
...
export const hrGeoEligibilityRules = pgTable(
  "hr_geo_eligibility_rules",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    policyGroupCode: text("policy_group_code").notNull().default("default"),
  ...
  (table) => [
    index("hr_geo_eligibility_rules_org_group_idx").on(
      table.organizationId,
      table.policyGroupCode,
    ),
    index("hr_geo_eligibility_rules_org_scope_idx").on(
      table.organizationId,
...
export const hrGeoRegisteredDevices = pgTable(
  "hr_geo_registered_devices",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_geo_registered_devices_org_fp_uidx").on(
      table.organizationId,
      table.deviceFingerprint,
    ),
    index("hr_geo_registered_devices_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrGeoRawCheckins = pgTable(
  "hr_geo_raw_checkins",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    validationFlags: jsonb("validation_flags")
      .$type<(typeof hrGeoValidationFlagEnum.enumValues)[number][]>()
      .notNull()
      .default([]),
  ...
  (table) => [
    index("hr_geo_raw_checkins_org_employee_captured_idx").on(
      table.organizationId,
      table.employeeId,
      table.capturedAt,
    ),
    uniqueIndex("hr_geo_raw_checkins_org_idempotency_uidx").on(
      table.organizationId,
...
export const hrGeoCheckinOutcomes = pgTable(
  "hr_geo_checkin_outcomes",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_geo_checkin_outcomes_org_employee_date_idx").on(
      table.organizationId,
      table.employeeId,
      table.workDate,
    ),
    index("hr_geo_checkin_outcomes_org_status_idx").on(
      table.organizationId,
      table.status,
    ),
...
export const hrGeoExceptions = pgTable(
  "hr_geo_exceptions",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_geo_exceptions_org_status_idx").on(
      table.organizationId,
      table.status,
    ),
    index("hr_geo_exceptions_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrGeoNotifications = pgTable(
  "hr_geo_notifications",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_geo_notifications_org_recipient_idx").on(
      table.organizationId,
      table.recipientAuthUserId,
    ),
    index("hr_geo_notifications_org_subject_idx").on(
      table.organizationId,
      table.subjectKind,
      table.subjectId,
    ),
...
export const hrGeoAuditEvents = pgTable(
  "hr_geo_audit_events",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_geo_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_geo_audit_events_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
