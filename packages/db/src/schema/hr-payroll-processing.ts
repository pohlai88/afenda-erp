...
export const hrPayrollEmployeeAssignmentStatusEnum = pgEnum(
  "hr_payroll_employee_assignment_status",
...
export const hrPayrollComponentCategoryEnum = pgEnum(
  "hr_payroll_component_category",
  [
    "basic_salary",
    "hourly_wage",
    "daily_wage",
...
export const hrPayrollCalculationMethodEnum = pgEnum(
  "hr_payroll_calculation_method",
  ["fixed_amount", "hourly_rate", "daily_rate", "percentage", "formula"],
);
...
export const hrPayrollAdjustmentStatusEnum = pgEnum(
  "hr_payroll_adjustment_status",
  ["draft", "pending_approval", "approved", "rejected", "applied", "cancelled"],
);

/** PAY-014 — proration scenario kinds. */
export const hrPayrollProrationScenarioEnum = pgEnum(
  "hr_payroll_proration_scenario",
  [
    "new_joiner",
    "resignation",
    "unpaid_leave",
...
export const hrPayrollValidationSeverityEnum = pgEnum(
  "hr_payroll_validation_severity",
  ["info", "warning", "error", "blocking"],
);

export const hrPayrollApprovalStepStatusEnum = pgEnum(
  "hr_payroll_approval_step_status",
...
export const hrPayrollPaymentBatchStatusEnum = pgEnum(
  "hr_payroll_payment_batch_status",
  [
    "draft",
    "generated",
    "submitted",
...
export const hrPayrollCorrectionStatusEnum = pgEnum(
  "hr_payroll_correction_status",
  [
    "draft",
...
export const hrPayrollPayGroups = pgTable(
  "hr_payroll_pay_groups",
  {
  ...
  (table) => [
    uniqueIndex("hr_payroll_pay_groups_org_code_uidx").on(
      table.organizationId,
      table.code,
    ),
    index("hr_payroll_pay_groups_org_status_idx").on(
      table.organizationId,
      table.payGroupStatus,
    ),
  ],
);

/** PAY-001 — payroll cycle by pay group, period, cutoff, pay date. */
export const hrPayrollCycles = pgTable(
  "hr_payroll_cycles",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_payroll_cycles_org_pay_group_code_uidx").on(
      table.organizationId,
      table.payGroupId,
      table.code,
    ),
    index("hr_payroll_cycles_org_status_idx").on(
      table.organizationId,
      table.cycleStatus,
    ),
    index("hr_payroll_cycles_org_pay_date_idx").on(
      table.organizationId,
      table.payDateAt,
    ),
  ],
...
export const hrPayrollEmployeeAssignments = pgTable(
  ...
  (table) => [
    index("hr_payroll_employee_assignments_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
      table.assignmentStatus,
    ),
    index("hr_payroll_employee_assignments_org_pay_group_idx").on(
      table.organizationId,
      table.payGroupId,
    ),
    uniqueIndex("hr_payroll_employee_assignments_org_group_employee_from_uidx").on(
      table.organizationId,
      table.payGroupId,
      table.employeeId,
      table.effectiveFrom,
...
export const hrPayrollEarningDeductionDefinitions = pgTable(
  "hr_payroll_earning_deduction_definitions",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_payroll_ed_definitions_org_code_uidx").on(
      table.organizationId,
      table.code,
      table.employeeId,
    ),
    index("hr_payroll_ed_definitions_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
      table.active,
    ),
    index("hr_payroll_ed_definitions_org_pay_group_idx").on(
      table.organizationId,
      table.payGroupId,
    ),
  ],
...
export const hrPayrollCycleInputs = pgTable(
  "hr_payroll_cycle_inputs",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_payroll_cycle_inputs_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
      table.inputStatus,
    ),
    index("hr_payroll_cycle_inputs_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
    index("hr_payroll_cycle_inputs_org_source_ref_idx").on(
      table.organizationId,
      table.inputSource,
      table.externalRef,
    ),
...
export const hrPayrollAdjustments = pgTable(
  ...
  (table) => [
    index("hr_payroll_adjustments_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
      table.adjustmentStatus,
    ),
    index("hr_payroll_adjustments_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrPayrollRuns = pgTable(
  ...
  (table) => [
    index("hr_payroll_runs_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
      table.runStatus,
    ),
    uniqueIndex("hr_payroll_runs_org_cycle_number_uidx").on(
      table.organizationId,
      table.cycleId,
      table.runNumber,
    ),
...
export const hrPayrollRunLines = pgTable(
  ...
  (table) => [
    uniqueIndex("hr_payroll_run_lines_org_run_employee_uidx").on(
      table.organizationId,
      table.runId,
      table.employeeId,
    ),
    index("hr_payroll_run_lines_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
    index("hr_payroll_run_lines_org_employee_idx").on(
      table.organizationId,
      table.employeeId,
    ),
  ],
...
export const hrPayrollValidations = pgTable(
  "hr_payroll_validations",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    runId: text("run_id")
  ...
  (table) => [
    index("hr_payroll_validations_org_run_idx").on(
      table.organizationId,
      table.runId,
      table.isBlocking,
    ),
    index("hr_payroll_validations_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
  ],
...
export const hrPayrollApprovals = pgTable(
  ...
  (table) => [
    index("hr_payroll_approvals_org_run_idx").on(
      table.organizationId,
      table.runId,
      table.stepOrder,
    ),
...
export const hrPayrollPayslips = pgTable(
  "hr_payroll_payslips",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    uniqueIndex("hr_payroll_payslips_org_run_employee_uidx").on(
      table.organizationId,
      table.runId,
      table.employeeId,
    ),
    uniqueIndex("hr_payroll_payslips_org_number_uidx").on(
      table.organizationId,
      table.payslipNumber,
    ),
    index("hr_payroll_payslips_org_employee_ess_idx").on(
      table.organizationId,
      table.employeeId,
      table.essAccessible,
    ),
...
export const hrPayrollPaymentBatches = pgTable(
  ...
  (table) => [
    uniqueIndex("hr_payroll_payment_batches_org_number_uidx").on(
      table.organizationId,
      table.batchNumber,
    ),
    index("hr_payroll_payment_batches_org_run_idx").on(
      table.organizationId,
      table.runId,
    ),
  ],
...
export const hrPayrollPayments = pgTable(
  "hr_payroll_payments",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
  ...
  (table) => [
    index("hr_payroll_payments_org_batch_idx").on(
      table.organizationId,
      table.batchId,
    ),
    index("hr_payroll_payments_org_employee_status_idx").on(
      table.organizationId,
      table.employeeId,
      table.paymentStatus,
    ),
...
export const hrPayrollJournalRefs = pgTable(
  "hr_payroll_journal_refs",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    runId: text("run_id")
  ...
  (table) => [
    uniqueIndex("hr_payroll_journal_refs_org_run_uidx").on(
      table.organizationId,
      table.runId,
    ),
    index("hr_payroll_journal_refs_org_journal_ref_idx").on(
      table.organizationId,
      table.journalReference,
    ),
  ],
);

/** PAY-029 — payroll corrections and reversals. */
export const hrPayrollCorrections = pgTable(
  "hr_payroll_corrections",
  {
    id: text("id").primaryKey(),
    organizationId: organizationReference(),
    ...
    correctionRunId: text("correction_run_id").references(
      () => hrPayrollRuns.id,
      { onDelete: "set null" },
    ),
    cycleId: text("cycle_id")
  ...
  (table) => [
    index("hr_payroll_corrections_org_source_run_idx").on(
      table.organizationId,
      table.sourceRunId,
    ),
    index("hr_payroll_corrections_org_status_idx").on(
      table.organizationId,
      table.correctionStatus,
    ),
  ],
);

/** PAY-030 — payroll audit trail. */
export const hrPayrollAuditEvents = pgTable(
  ...
  (table) => [
    index("hr_payroll_audit_events_org_occurred_idx").on(
      table.organizationId,
      table.occurredAt,
    ),
    index("hr_payroll_audit_events_org_cycle_idx").on(
      table.organizationId,
      table.cycleId,
    ),
    index("hr_payroll_audit_events_org_run_idx").on(
      table.organizationId,
      table.runId,
    ),
  ],
