...
**Golden path:** follow ARCH-010, then copy or scaffold from
`src/employee-management/compliance-regulatory-tracking/` for every new shipped
capability. Do not restore legacy `@afenda/feature-hr` layouts.
