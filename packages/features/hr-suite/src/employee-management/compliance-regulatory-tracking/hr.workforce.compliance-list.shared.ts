...
import type { HrmComplianceFilingEffectiveStatus } from "./hr.workforce.compliance-filing.shared";
import type { HrmComplianceRequirementStatus } from "./hr.workforce.compliance-status.shared";
import type { HrmComplianceWorkEligibilityStatus } from "./hr.workforce.compliance-work-eligibility.shared";
import type { HrmComplianceWorkAuthDocumentEffectiveStatus } from "./hr.workforce.compliance-work-auth-documents.shared";
