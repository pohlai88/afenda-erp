...
import { deriveEffectiveWorkAuthDocumentStatus, normalizeWorkAuthStatusForTrailingSelect } from "./hr.workforce.compliance-work-auth-documents.shared";
...
} from "./hr.workforce.compliance-sensitive-access.shared";
