...
import { hrLifecycleRoutePaths } from "../contracts/hr.workforce.lifecycle-route.contract";
import type { HrWorkforceLifecycleAuditAction } from "../events/hr.workforce.lifecycle.event";
import { toLifecycleActionFailure } from "../data/hr.workforce.lifecycle-action-result.shared";
