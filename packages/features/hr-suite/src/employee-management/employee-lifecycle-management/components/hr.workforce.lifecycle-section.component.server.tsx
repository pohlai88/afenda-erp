...
import type { HrLifecyclePageModel } from "../data/hr.workforce.lifecycle.page-model.server";
...
import { hrLifecycleOverviewStatSurfaceKey } from "../surface/hr.workforce.lifecycle-overview-stat.surface";
