...
import type { HrRecordsAuditAction } from "../events/hr.workforce.records.event";
import { toRecordsActionFailure } from "../data/hr.workforce.records-action-result.shared";
