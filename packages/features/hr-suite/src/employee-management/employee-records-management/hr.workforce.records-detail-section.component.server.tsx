...
import type { HrEmployeeRecordDetailPageModel } from "./hr.workforce.records.detail.page-model.server";
import { hrRecordsRoutePaths } from "./hr.workforce.records-route.contract";
