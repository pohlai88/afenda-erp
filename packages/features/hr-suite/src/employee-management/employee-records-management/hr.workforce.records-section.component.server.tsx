...
import type { HrRecordsPageModel } from "./hr.workforce.records.page-model.server";
import { hrRecordsAssignmentsSurfaceKey } from "./hr.workforce.records-assignments-list.surface";
import { hrRecordsAuditTrailSurfaceKey } from "./hr.workforce.records-audit-trail-list.surface";
import { hrRecordsDirectorySurfaceKey } from "./hr.workforce.records-directory-list.surface";
import { hrRecordsDocumentReferencesSurfaceKey } from "./hr.workforce.records-document-references-list.surface";
import { hrRecordsIncompleteSurfaceKey } from "./hr.workforce.records-incomplete-list.surface";
import { hrRecordsOverviewStatSurfaceKey } from "./hr.workforce.records-overview-stat.surface";
import { hrRecordsSeparatedSurfaceKey } from "./hr.workforce.records-separated-list.surface";
import { hrRecordsStatusHistorySurfaceKey } from "./hr.workforce.records-status-history-list.surface";
