...
import type { HrOffboardingPageModel } from "../data/hr.workforce.offboarding.page-model.server";
import { hrLifecycleRoutePaths } from "../../employee-lifecycle-management/contracts/hr.workforce.lifecycle-route.contract";
...
import { hrOffboardingOverviewStatSurfaceKey } from "../surface/hr.workforce.offboarding-overview-stat.surface";
