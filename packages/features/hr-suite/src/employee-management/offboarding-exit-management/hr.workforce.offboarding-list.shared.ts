...
import { hrWorkforceOffboardingReadPermission } from "./hr.workforce.offboarding.contract";
import { formatOffboardingEnumLabel } from "./hr.workforce.offboarding-form.shared";
