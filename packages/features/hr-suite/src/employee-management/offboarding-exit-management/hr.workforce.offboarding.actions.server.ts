...
import { hrWorkforceOffboardingAuditActions } from "./hr.workforce.offboarding.event";
import { requireHrOffboardingWrite } from "./hr.workforce.offboarding-access.policy.server";
import {
...
} from "./hr.workforce.offboarding-form.shared";
