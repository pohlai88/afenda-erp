...
import { hrOffboardingRoutePaths } from "./hr.workforce.offboarding-route.contract";
import type { HrWorkforceOffboardingAuditAction } from "./hr.workforce.offboarding.event";
import { toOffboardingActionFailure } from "./hr.workforce.offboarding-action-result.shared";
