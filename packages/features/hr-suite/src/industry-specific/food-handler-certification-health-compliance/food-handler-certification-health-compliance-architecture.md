...
| **HRM-FHC-022** | System shall provide food handler compliance overview by outlet, role, department, manager, legal entity, and status.                                                            |
...
|  20 | Compliance overview can show readiness by outlet, role, department, manager, legal entity, and status.                                                          |
