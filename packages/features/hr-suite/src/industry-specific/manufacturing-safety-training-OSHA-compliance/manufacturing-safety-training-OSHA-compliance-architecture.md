...
| **Safety Erp**                | Training compliance, incident trends, overdue actions, high-risk departments              |
...
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Manufacturing Safety Training & OSHA Compliance** | Tracks manufacturing safety training, OSHA or local occupational safety compliance references, PPE training, hazard assessments, safety certifications, incident reporting references, corrective actions, work restriction status, compliance overview surfaces, reporting, and audit history. |
...
| **HRM-MSC-028** | System shall provide safety compliance overview surfaces by site, department, role, manager, training type, incident type, hazard status, and risk level.                                                                                       |
...
|  25 | Safety compliance overview can show status by site, department, role, manager, training type, incident type, hazard status, and risk level.                                         |
