...
import { HR_BENEFITS_SENSITIVE_READ_CAPABILITY } from "../data/hr.payroll.benefits-sensitive-access.shared";
import { HrBenefitsSensitiveAccessError } from "../data/hr.payroll.benefits-org-scope.shared";
