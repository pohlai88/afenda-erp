...
import { hrBonusRoutePaths } from "../contracts/hr.payroll.bonus-route.contract";
import type { HrPayrollBonusAuditAction } from "../events/hr.payroll.bonus.event";
import { toBonusActionFailure } from "../data/hr.payroll.bonus-action-result.shared";
...
export { toBonusActionFailure } from "../data/hr.payroll.bonus-action-result.shared";
