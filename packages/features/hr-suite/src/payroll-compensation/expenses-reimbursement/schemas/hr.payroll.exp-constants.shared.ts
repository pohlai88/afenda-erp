...
export const HR_EXPENSE_FINANCE_APPROVE_CAPABILITY =
  "hr.expense.finance.approve" as const;
export const HR_EXPENSE_EXCEPTION_APPROVE_CAPABILITY =
  "hr.expense.exception.approve" as const;
