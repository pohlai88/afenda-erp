...
import { buildHrMcpCrossCountryCostReportCsv } from "../data/hr.payroll.mcp-cross-country-reports.shared";
import { buildHrMcpRuleVersionSnapshotPayload } from "../data/hr.payroll.mcp-rule-versioning.shared";
import {
  requireHrMcpRead,
  requireHrMcpWrite,
