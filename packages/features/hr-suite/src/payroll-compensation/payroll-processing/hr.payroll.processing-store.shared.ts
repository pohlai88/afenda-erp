...
import type { HrPayrollAdjustmentRecord } from "./hr.payroll.processing-adjustment.schema";
import type { HrPayrollInputStagingRow } from "./hr.payroll.processing-input-staging.schema";
import type { HrPayrollValidationResult } from "./hr.payroll.processing-validation.schema";
