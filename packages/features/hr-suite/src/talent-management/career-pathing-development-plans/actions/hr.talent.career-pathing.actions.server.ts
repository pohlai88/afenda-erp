...
import { hrCareerPathAspirationUpsertSchema } from "../schemas/hr.talent.career-pathing-aspiration.schema";
import {
  hrCareerPathDevelopmentGoalCreateSchema,
  hrCareerPathDevelopmentGoalStatusSchema,
} from "../schemas/hr.talent.career-pathing-goal.schema";
import {
  hrCareerPathFrameworkStatusSchema,
  hrCareerPathFrameworkUpsertSchema,
} from "../schemas/hr.talent.career-pathing-framework.schema";
import { hrCareerPathDevelopmentMilestoneCreateSchema } from "../schemas/hr.talent.career-pathing-milestone.schema";
import { hrCareerPathDevelopmentPlanCreateSchema } from "../schemas/hr.talent.career-pathing-plan.schema";
import {
  hrCareerPathTargetRoleRecommendSchema,
  hrCareerPathTargetRoleUpsertSchema,
} from "../schemas/hr.talent.career-pathing-target-role.schema";
