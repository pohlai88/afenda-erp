...
import type { HrCareerPathPageModel } from "../data/hr.talent.career-pathing-foundation.page-model.server";
import {
...
import { hrTalentCareerPathingUiCopy } from "../surface/hr.talent.career-pathing-ui.copy.shared";
