...
import { hrCareerPathingAuditTrailSurfaceKey } from "./hr.talent.career-pathing-audit-trail-list.surface";
import { hrCareerPathingReadinessSurfaceKey } from "./hr.talent.career-pathing-readiness-list.surface";
import { hrCareerPathingReportsSurfaceKey } from "./hr.talent.career-pathing-reports-list.surface";
