import type { HrCsfMatchTargetKind } from "../schemas/hr.talent.csf-constants.shared";
import type { HrCsfEmployeeSkillMatch } from "../contracts/hr.talent.csf-integration.contract";
import {
