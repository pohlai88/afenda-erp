...
type PerformanceAcceptanceCriteriaCoverageSeed = readonly [
  criterion: number,
  requirements: readonly `HRM-PER-${string}`[],
];

const PERFORMANCE_ACCEPTANCE_CRITERIA_COVERAGE_SEEDS = [
  ...
  [23, ["HRM-PER-028"]],
  [24, ["HRM-PER-031"]],
] satisfies readonly PerformanceAcceptanceCriteriaCoverageSeed[];

export const PERFORMANCE_ACCEPTANCE_CRITERIA_COVERAGE: readonly PerformanceAcceptanceCriteriaCoverage[] =
  PERFORMANCE_ACCEPTANCE_CRITERIA_COVERAGE_SEEDS.map(
