...
import { buildHrLamAttendanceDaysListSurface } from "../surface/hr.time.lam-attendance-days-list.surface";
import { buildHrLamAuditTrailListSurface } from "../surface/hr.time.attendance.lam-audit-trail-list.surface";
import { buildHrLamCorrectionsListSurface } from "../surface/hr.time.attendance.lam-corrections-list.surface";
import { buildHrLamExceptionsListSurface } from "../surface/hr.time.attendance.lam-exceptions-list.surface";
import { buildHrLamLeaveBalancesListSurface } from "../surface/hr.time.lam-leave-balances-list.surface";
import { buildHrLamLeaveRequestsListSurface } from "../surface/hr.time.lam-leave-requests-list.surface";
import { buildHrLamPayrollRefsListSurface } from "../surface/hr.time.attendance.lam-payroll-refs-list.surface";
import { buildHrLamReportsListSurface } from "../surface/hr.time.attendance.lam-reports-list.surface";
