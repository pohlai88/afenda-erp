...
import { hrLamRoutePaths } from "./hr.time.lam-route.contract";
import type { HrTimeLamAuditAction } from "./hr.time.lam.event";
import { toHrLamActionFailure } from "./hr.time.lam-action-result.shared";
