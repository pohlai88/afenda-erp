...
import { hrSftUiCopy } from "../surface/hr.time.sft-ui.copy.shared";
import { hrSftAttendanceReconcileSurfaceKey } from "../surface/hr.time.sft-attendance-reconcile-list.surface";
import { hrSftAuditTrailSurfaceKey } from "../surface/hr.time.sft-audit-trail-list.surface";
import { hrTimeSftAvailabilitySurfaceKey } from "../surface/hr.time.sft-availability-list.surface";
import { hrTimeSftCoverageSurfaceKey } from "../surface/hr.time.sft-coverage-list.surface";
import { hrTimeSftMyScheduleChangesSurfaceKey } from "../surface/hr.time.sft-my-schedule-changes-list.surface";
import { hrTimeSftMySwapsSurfaceKey } from "../surface/hr.time.sft-my-swaps-list.surface";
import { hrSftNotificationsSurfaceKey } from "../surface/hr.time.sft-notifications-list.surface";
import { hrSftPayrollRefsSurfaceKey } from "../surface/hr.time.sft-payroll-refs-list.surface";
import { hrSftPublicationsSurfaceKey } from "../surface/hr.time.sft-publications-list.surface";
import { hrTimeSftRecurrenceRulesSurfaceKey } from "../surface/hr.time.sft-recurrence-rules-list.surface";
import { hrSftReportDefinitionsSurfaceKey } from "../surface/hr.time.sft-report-definitions-list.surface";
import { hrTimeSftRosterSurfaceKey } from "../surface/hr.time.sft-roster-list.surface";
import { hrTimeSftScheduleChangePendingSurfaceKey } from "../surface/hr.time.sft-schedule-change-pending-list.surface";
import { hrTimeSftSwapPendingSurfaceKey } from "../surface/hr.time.sft-swap-pending-list.surface";
import { hrTimeSftTemplatesSurfaceKey } from "../surface/hr.time.sft-templates-list.surface";
