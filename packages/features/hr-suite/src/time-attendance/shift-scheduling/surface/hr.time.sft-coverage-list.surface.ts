import type { HrSftCoverageCompareWindow } from "../data/hr.time.sft-coverage.server";
import { formatCoverageStaffingStatusLabel } from "../data/hr.time.sft-coverage.shared";
import {
