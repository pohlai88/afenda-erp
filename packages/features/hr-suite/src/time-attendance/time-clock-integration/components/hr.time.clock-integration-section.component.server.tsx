...
import type { HrTimeClockPageModel } from "../data/hr.time.clock-integration.page-model.server";
...
import { hrTimeClockOverviewStatSurfaceKey } from "../surface/hr.time.clock-integration-overview-stat.surface";
