...
import { buildHrTimeClockAuditTrailListSurface } from "./hr.time.clock-integration-audit-trail-list.surface";
import { buildHrTimeClockDevicesListSurface } from "./hr.time.clock-integration-devices-list.surface";
import { buildHrTimeClockEmployeeMappingsListSurface } from "./hr.time.clock-integration-employee-mappings-list.surface";
import { buildHrTimeClockLamExportListSurface } from "./hr.time.clock-integration-lam-export-list.surface";
import { buildHrTimeClockOvertimeRefsListSurface } from "./hr.time.clock-integration-overtime-refs-list.surface";
import { buildHrTimeClockPayrollRefsListSurface } from "./hr.time.clock-integration-payroll-refs-list.surface";
import { buildHrTimeClockPunchExceptionsListSurface } from "./hr.time.clock-integration-punch-exceptions-list.surface";
import { buildHrTimeClockRawPunchesListSurface } from "./hr.time.clock-integration-raw-punches-list.surface";
import { buildHrTimeClockReportsListSurface } from "./hr.time.clock-integration-reports-list.surface";
import { buildHrTimeClockSyncBatchesListSurface } from "./hr.time.clock-integration-sync-batches-list.surface";
import { buildHrTimeClockOverviewStatGrid } from "./hr.time.clock-integration-overview-stat.surface";
import {
...
import { hrTimeClockReportGroupByParam } from "./hr.time.clock-integration-reports-list.surface";
