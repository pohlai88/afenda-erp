...
**Import rule:** Other HRM pillars may import via relative path. Cross-module callers use explicit bounded-context package doors only — no deep imports from `app/`.
