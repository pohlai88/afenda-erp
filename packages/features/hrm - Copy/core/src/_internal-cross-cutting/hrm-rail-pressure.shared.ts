...
import type { HrmRailPressureBadge, HrmRailPressureTone } from "@afenda/feature-hrm-core/shared"

/**
 * Phase 2 threshold policy — HRM app surface. Constants live alongside the
