...
| `buildGovernedHrmModulePageHeader` | |

**Import rule:** Pillar `actions/` and `data/*-action-guard.server.ts` import relatively. External surfaces use explicit bounded-context server package doors.
