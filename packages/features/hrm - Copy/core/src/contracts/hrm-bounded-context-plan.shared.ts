    ...
    integrationDoors: [
      {
        id: "registry",
        futurePublicDoor: ".",
        currentCompatibilityDoor: "@afenda/feature-hrm-core/registry",
        blocksMoveBecause:
      ...
      },
      {
        ...
        currentCompatibilityDoor: "@afenda/feature-hrm-core/server",
        blocksMoveBecause:
      ...
      },
      {
        ...
        currentCompatibilityDoor: "@afenda/feature-hrm-core/shared",
        blocksMoveBecause:
          "Cross-context list builders still import the root compatibility shim; migrate to @afenda/feature-hrm-core/shared.",
      },
      {
        id: "nexus-pressure",
        futurePublicDoor: "./server",
    ...
    integrationDoors: [
      {
        ...
        futurePublicDoor: "./server",
        currentCompatibilityDoor:
          "@afenda/feature-hrm-employee-management/server",
        blocksMoveBecause:
      ...
      },
      {
        ...
        currentCompatibilityDoor:
          "@afenda/feature-hrm-employee-management/client",
        blocksMoveBecause:
    ...
    integrationDoors: [
      {
        ...
        futurePublicDoor: "./server",
        currentCompatibilityDoor: "@afenda/feature-hrm-time-attendance/server",
        blocksMoveBecause:
      ...
      },
      {
        ...
        futurePublicDoor: "./client",
        currentCompatibilityDoor: "@afenda/feature-hrm-time-attendance/client",
        blocksMoveBecause:
    ...
    integrationDoors: [
      {
        ...
        futurePublicDoor: "./server",
        currentCompatibilityDoor:
          "@afenda/feature-hrm-payroll-compensation/server",
        blocksMoveBecause:
    ...
    integrationDoors: [
      {
        ...
        futurePublicDoor: "./server",
        currentCompatibilityDoor:
          "@afenda/feature-hrm-talent-management/server",
        blocksMoveBecause:
