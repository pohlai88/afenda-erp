...
import { getPayrollPeriod } from "@afenda/feature-hrm-payroll-compensation/server"
import { resolveRulePack } from "@afenda/feature-hrm-payroll-compensation/server"
import type { StatutoryPackType } from "@afenda/feature-hrm-payroll-compensation/server"
...
import { HRM_COMPLIANCE_EXECUTION_AUDIT_ACTIONS } from "../data/compliance-timeline.shared"
...
import { hrmCodedActionFailure } from "@afenda/feature-hrm-core/governance"
import type { SubmitStatutoryEvidenceFormState } from "@afenda/feature-hrm-core/shared"
 ...
 * delivery pipeline shipped with `system-admin` — no parallel signing or
