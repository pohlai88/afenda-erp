...
import { EmployeeDetailSummaryListSection } from "./employee-detail-summary-list-section"
...
export async function EmployeeDetailPage({
  ...
  const summaryRows = [
    {
      id: "legal-name",
      field: t("fieldLegalName"),
      value: employee.legalName,
    },
    {
      id: "preferred-name",
      field: t("fieldPreferredName"),
    ...
    {
      id: "updated",
      field: t("detailUpdated"),
      value: updatedLabel,
    },
    {
      id: "department",
      field: t("masterRecord.fields.department"),
      value: placementLabel(snapshot.placementLabels.department),
    },
    {
      id: "position",
      field: t("masterRecord.fields.position"),
      value: placementLabel(snapshot.placementLabels.position),
    },
    {
      id: "job-grade",
      field: t("masterRecord.fields.jobGrade"),
      value: placementLabel(snapshot.placementLabels.jobGrade),
    },
    {
      id: "manager",
      field: t("masterRecord.fields.manager"),
      value: placementLabel(snapshot.placementLabels.manager),
    },
    {
      id: "linked-user",
      field: t("masterRecord.fields.linkedUser"),
      value: placementLabel(snapshot.placementLabels.linkedUser),
    },
  ] as const
    ...
    <div className="flex flex-col gap-6">
      ...
      <Card size="sm">
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <EmployeeDetailSummaryListSection rows={summaryRows} />
