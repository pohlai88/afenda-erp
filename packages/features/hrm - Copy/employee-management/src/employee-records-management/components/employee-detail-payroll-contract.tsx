...
import { listPayrollGroupsForOrg } from "@afenda/feature-hrm-payroll-compensation/server"
...
import { PayrollProfileForm } from "@afenda/feature-hrm-payroll-compensation/client"
...
export async function EmployeeDetailPayrollContract({
  ...
  const [
    ...
    getTranslations("Erp.Hrm.workforce.contractTypes"),
    getTranslations("Erp.Hrm.workforce.payFrequencies"),
    getFormatter(),
    ...
    listPayrollGroupsForOrg(organizationId),
  ])
