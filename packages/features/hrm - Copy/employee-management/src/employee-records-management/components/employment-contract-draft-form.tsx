...
import { createDraftContractAction } from "@afenda/feature-hrm-employee-management/client"
...
export function EmploymentContractDraftForm({
  ...
  const tContractTypes = useTranslations("Erp.Hrm.workforce.contractTypes")
  const tPayFrequencies = useTranslations("Erp.Hrm.workforce.payFrequencies")
