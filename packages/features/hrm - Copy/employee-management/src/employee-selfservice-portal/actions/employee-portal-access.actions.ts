...
import { ORG_APPS_HRM_EMPLOYEE_DETAIL } from "@afenda/platform/org-apps-module-paths"
import { db } from "@afenda/platform/db"
import { organizationPortalAccess } from "@afenda/platform/db/schema"
...
import type { EmployeePortalAccessFormState } from "@afenda/feature-hrm-core/shared"
...
function revalidateEmployeePortalAccess(): void {
  ...
  revalidatePath(toLocalePortalRevalidatePattern("/employee/requests"), "page")
}
