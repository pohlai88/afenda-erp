...
import { toLocalePortalRevalidatePattern } from "@afenda/platform/portal"
...
import { completeBoardingTasksForTrainingRecord } from "@afenda/feature-hrm-talent-management/server"
import { appendTrainingEvent } from "@afenda/feature-hrm-talent-management/server"
import { createTrainingRecordInTransaction } from "@afenda/feature-hrm-talent-management/server"
import { linkTrainingCompletionToComplianceEvidence } from "@afenda/feature-hrm-talent-management/server"
import { grantSkillFromTrainingRecord } from "@afenda/feature-hrm-talent-management/server"
import { updateTrainingRecordFeedback } from "@afenda/feature-hrm-talent-management/server"
import {
  completeTrainingRecordFormSchema,
  submitTrainingFeedbackFormSchema,
} from "@afenda/feature-hrm-talent-management/schemas"
import { HRM_TRAINING_AUDIT } from "@afenda/feature-hrm-talent-management/server"
