...
import { GovernedEmpty } from "@afenda/governed-surface/server"
...
import { EmployeePortalLeaveTrailingCell } from "./employee-portal-list-trailing-cells.client"
          ...
          <Card size="sm">
            ...
            <CardContent>
              <GovernedPatternCListSection
                ...
                trailingColumn={{
                  header: t("colActions"),
                  Cell: EmployeePortalLeaveTrailingCell,
                  context: {
                    portalSlug: context.portal.portalSlug,
                    requests: historyRows.map((row) => ({
                      id: row.id,
                      state: row.state,
                    })),
                  },
