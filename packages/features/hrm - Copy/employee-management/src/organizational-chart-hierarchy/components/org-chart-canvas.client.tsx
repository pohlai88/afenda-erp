...
function OrgChartFlowNode({
  ...
  const t = useTranslations("Erp.Hrm.organization.chart")
  const kindLabel =
              ...
              <div className="flex flex-col gap-3">
                {selected.kind === "employee" ? (
                  <Button asChild variant="outline" size="sm">
                    <Link
                      href={
                        `/o/${orgSlug}/apps/hrm/employees/${selected.resourceId}` as Route
                      }
                    >
                      {t("openEmployee")}
                    </Link>
                ...
                {selected.kind === "employee" ? (
                  <Button asChild variant="ghost" size="sm">
                    <Link
                      href={
                        `/o/${orgSlug}/apps/hrm/organization?tab=assignments` as Route
                      }
                    >
                      {t("openAssignments")}
                    </Link>
