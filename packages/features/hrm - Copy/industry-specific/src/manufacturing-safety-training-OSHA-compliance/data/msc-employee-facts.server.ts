...
import type { MscEmployeeMatchFacts } from "./msc-rule-match.shared"
...
export async function resolveMscEmployeeMatchFacts(input: {
  organizationId: string
  employeeId: string
}): Promise<MscEmployeeMatchFacts> {
  ...
  return {
    ...
    riskCategory: employeeRow?.workerCategory ?? null,
  }
}
