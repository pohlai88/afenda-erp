...
function useEnrollmentFormRefresh<
...
function SuspendEnrollmentForm({ enrollmentId }: { enrollmentId: string }) {
  const t = useTranslations("Erp.Hrm.benefits.enrollmentTable")
  const reasonId = useId()
  const [state, formAction, pending] = useActionState(
    suspendBenefitEnrollmentAction,
    undefined
  )
  useEnrollmentFormRefresh(state)
