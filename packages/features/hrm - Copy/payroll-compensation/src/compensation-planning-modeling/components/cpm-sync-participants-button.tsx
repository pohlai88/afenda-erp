...
import { syncCompensationCycleParticipantsAction } from "@afenda/feature-hrm-payroll-compensation/client"

export function CpmSyncParticipantsButton({ cycleId }: { cycleId: string }) {
  const t = useTranslations("Erp.Hrm.compensationPlanning")
