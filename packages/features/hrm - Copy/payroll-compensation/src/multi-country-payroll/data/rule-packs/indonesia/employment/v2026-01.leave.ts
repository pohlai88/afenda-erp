...
export const ID_EMPLOYMENT_LEAVE_TYPES_2026: readonly IndonesiaEmploymentLeaveTypeSeed[] =
  [
    {
      code: "ANNUAL",
      labelKey: "Erp.Hrm.rulePackId.leaveAnnual",
      paid: true,
      requiresEvidence: false,
    },
    {
      code: "SICK",
      labelKey: "Erp.Hrm.rulePackId.leaveSick",
      paid: true,
      requiresEvidence: true,
    },
    {
      code: "MATERNITY",
      labelKey: "Erp.Hrm.rulePackId.leaveMaternity",
      paid: true,
      requiresEvidence: true,
    },
    {
      code: "PATERNITY",
      labelKey: "Erp.Hrm.rulePackId.leavePaternity",
      paid: true,
      requiresEvidence: true,
    },
  ]
