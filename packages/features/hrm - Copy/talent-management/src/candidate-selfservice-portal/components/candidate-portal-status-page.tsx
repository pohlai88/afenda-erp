...
import { hrmApplication, hrmJobRequisition } from "@afenda/platform/db/schema"

import { buildCandidateApplicationStatusStatConfiguration } from "../data/candidate-portal-surface-builders.server"
import { CANDIDATE_PORTAL_APPLICATION_STATUS_SURFACE_KEY } from "../data/candidate-portal-surface-metadata.shared"
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <GovernedPatternBStatSection
        title=""
        layout="embedded"
        surfaceKey={CANDIDATE_PORTAL_APPLICATION_STATUS_SURFACE_KEY}
        statGroups={[
          {
            groupKey: "status",
