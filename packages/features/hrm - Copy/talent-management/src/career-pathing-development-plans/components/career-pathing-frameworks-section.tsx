...
import { CareerPathFrameworkCreateForm } from "./career-pathing-forms.client"
import { CareerPathFrameworkTrailingCell } from "./career-pathing-list-trailing-cells.client"
        ...
        <GovernedPatternCListSection
          ...
          trailingColumn={
            isHrmAdmin
              ? {
                  header: "",
                  Cell: CareerPathFrameworkTrailingCell,
                  context: {
                    organizationId,
                    orgSlug,
                    frameworks: frameworks.map((framework) => ({
                      id: framework.id,
                      status: framework.status as
                        | "draft"
                        | "active"
                        | "archived",
                    })),
