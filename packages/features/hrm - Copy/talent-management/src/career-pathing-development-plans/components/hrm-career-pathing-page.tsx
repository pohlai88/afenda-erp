...
import { CareerPathingOverviewSection } from "./career-pathing-overview-section"
...
export async function HrmCareerPathingPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <CareerPathingOverviewSection organizationId={organizationId} />
      ...
      <CareerPathingReadinessSection {...sectionProps} />
    </div>
  )
}
