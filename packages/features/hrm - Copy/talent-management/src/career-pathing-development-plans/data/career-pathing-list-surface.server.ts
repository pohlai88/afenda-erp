...
export type CareerDiscussionListRow = {
  readonly id: string
  readonly employeeId: string
  readonly employeeName: string
  readonly discussionDate: string
  readonly nextReviewDate: string | null
  readonly notes: string | null
}

export function buildCareerDiscussionsListSurfaceConfiguration(
  rows: readonly CareerDiscussionListRow[],
  orgSlug: string,
  copy: {
    empty: string
    colEmployee: string
    colDiscussionDate: string
    colNextReview: string
    colNotes: string
  ...
  return buildGovernedListSurface({
    ...
    requiresErpPermission: CAREER_PATH_READ_PERMISSION,
    surface: {
      header: { title: "hrm-career-discussions" },
    ...
    columns: [
      { id: "employee", header: copy.colEmployee },
      { id: "discussionDate", header: copy.colDiscussionDate },
      { id: "nextReview", header: copy.colNextReview },
    ...
    rows: rows.map((row) => ({
      ...
      cells: {
        employee: row.employeeName,
        discussionDate: copy.formatDate(row.discussionDate),
        nextReview: row.nextReviewDate
          ? copy.formatDate(row.nextReviewDate)
          : "—",
...
export function buildOverviewKpiSurfaceConfiguration(input: {
  ...
  return buildGovernedListSurface({
    ...
    requiresErpPermission: CAREER_PATH_READ_PERMISSION,
    surface: {
      header: { title: "career-pathing-overview-kpi" },
      columnsId: "hrm-career-path-overview-kpi",
      rowKey: "id",
