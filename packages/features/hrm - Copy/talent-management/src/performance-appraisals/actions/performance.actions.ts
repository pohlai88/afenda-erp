...
} from "@afenda/platform/erp/rbac.server"
import { writeIamAuditEventFromNextHeaders } from "@afenda/platform/auth"
import { ORG_APPS_HRM_PERFORMANCE } from "@afenda/platform/org-apps-module-paths"
import { db } from "@afenda/platform/db"
import { hrmEmployee, hrmReview, hrmReviewCycle } from "@afenda/platform/db/schema"
...
function revalidatePerformanceSurface() {
  revalidatePath(
    toLocaleOrgAppsRevalidatePattern(ORG_APPS_HRM_PERFORMANCE),
    "page"
  )
}
