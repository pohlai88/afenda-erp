...
import { hrmTrainingAssignment, hrmTrainingRecord } from "@afenda/platform/db/schema"
import type { CronTickScannedEmittedSummary } from "@afenda/platform/erp/cron-tick.shared"
