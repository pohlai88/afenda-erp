...
import { HRM_EMPLOYMENT_TYPES } from "@afenda/feature-hrm-employee-management/schemas"
import {
...
export function RemoteCheckinPolicyDialog({
  ...
  const t = useTranslations("Erp.Hrm.Geolocation.policies")
  const tScope = useTranslations("Erp.Hrm.Geolocation.policies.scopeLabels")
  const tCommon = useTranslations("Erp.Hrm.Geolocation")
