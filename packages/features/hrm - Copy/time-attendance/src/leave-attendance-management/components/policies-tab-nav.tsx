...
import { organizationHrmPath } from "@afenda/feature-hrm-time-attendance/client"
...
/**
 * URL-driven tab navigator for the HR Policies surface.
 *
 * Each tab is a real `Link`-as-anchor (not a button + router push) so
 * Cmd-click / middle-click open in a new tab and the route is
 * server-rendered on first navigation  same idiom we use across the
 * system-admin sidebar. We intentionally render this as one stateless
