...
import { hrmLeavePolicy, hrmLeaveType } from "@afenda/platform/db/schema"

// ---------------------------------------------------------------------------
// Org-scoped read surface for the HR Policies surface (PR #4 — §6.11
...
/**
 * Decorated `hrm_leave_type` row used by the Policies surface. Adds
 ...
 * updated first. The Policies surface renders archived rows behind a
