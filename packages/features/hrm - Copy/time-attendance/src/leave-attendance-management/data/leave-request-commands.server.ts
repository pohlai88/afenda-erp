...
import { hrmApproval, hrmLeaveRequest } from "@afenda/platform/db/schema"
...
import { withPortalMutationSpan } from "@afenda/feature-hrm-employee-management/server"
import type {
...
async function cancelLeaveRequestForContextBody(
  ...
  await writeIamAuditEventFromNextHeaders({
    ...
    metadata: {
      ...
      submissionMode:
        input.mode === "employee_portal" ? "self_service" : "org_apps",
