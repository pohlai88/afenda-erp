...
/** Filter for offboarding overview. HRM-OFF-026. */
export const offboardingOverviewFilterSchema = z.object({
...
export type OffboardingOverviewFilterInput = z.infer<
  typeof offboardingOverviewFilterSchema
>
