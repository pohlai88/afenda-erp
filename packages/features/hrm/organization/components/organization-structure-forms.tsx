...
function OrganizationDepartmentCreateDialogBody({
  ...
  const t = useTranslations("Erp.Hrm.organization.departments")
...
function OrganizationJobGradeCreateDialogBody({
  ...
  const t = useTranslations("Erp.Hrm.organization.grades")
  const [state, formAction, pending] = useActionState(
    createJobGradeAction,
    undefined
  )
...
function OrganizationPositionCreateDialogBody({
  ...
  const t = useTranslations("Erp.Hrm.organization.positions")
  const [state, formAction, pending] = useActionState(
    createPositionAction,
    undefined
  )
...
function OrganizationAssignmentDialogBody({
  ...
  const t = useTranslations("Erp.Hrm.organization.assignments")
  const [state, formAction, pending] = useActionState(
    assignEmployeePlacementAction,
    undefined
  )
