...
import { enqueuePayrollFinalizeWorkflowRun } from "../data/payroll-finalize-enqueue.server"
import {
  getPayrollPeriod,
...
import { payrollFinalizePayloadSchema } from "../data/payroll-finalize-payload.shared"
...
export async function lockPayrollPeriodAction(
  ...
  // newly-paid claims. Use the standard revalidate pattern so all locales rebuild.
