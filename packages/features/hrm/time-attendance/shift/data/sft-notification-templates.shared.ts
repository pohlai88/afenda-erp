  ...
  return {
    ...
    email: {
      ...
      text: [
        ...
        inAppBody,
        `Open shift scheduling: ${input.scheduleUrl}`,
      ].join("\n"),
      html: emailHtml([
        "<strong>Afenda Shift Scheduling</strong>",
        inAppBody,
        `<a href="${input.scheduleUrl}">Open shift scheduling</a>`,
      ]),
    },
  }
}
  ...
  return {
    ...
    email: {
      ...
      text: [
        "Afenda Shift Scheduling",
        inAppBody,
        `View roster: ${input.scheduleUrl}`,
      ].join("\n"),
      html: emailHtml([
        "<strong>Afenda Shift Scheduling</strong>",
        inAppBody,
        `<a href="${input.scheduleUrl}">View roster</a>`,
      ]),
    },
  }
}
