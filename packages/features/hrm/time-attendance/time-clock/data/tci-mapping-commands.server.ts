...
import { hrmTimeClockEmployeeMapping } from "@afenda/platform/db/schema"
...
export async function upsertTimeClockMapping(
  ...
  await writeIamAuditEventFromNextHeaders({
    action: isUpdate
      ? HRM_TCI_AUDIT.mappingUpdate
      : HRM_TCI_AUDIT.mappingCreate,
    ...
    metadata: {
      ...
      biometricRef: values.biometricRef,
    },
  })
