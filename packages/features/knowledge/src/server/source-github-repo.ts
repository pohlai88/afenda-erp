...
export type GitHubRepoSourceConfig = z.infer<typeof githubRepoConfigSchema>;
 ...
 * Walks the tree recursively and yields .md/.mdx/.txt files.
 * Requires GITHUB_TOKEN env var for private repos.
 */
export const githubRepoSourceAdapter: KnowledgeSourceAdapter<GitHubRepoSourceConfig> =
  {
    id: "github_repo",
