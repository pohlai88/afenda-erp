...
export type LynxErpReadToolId = (typeof LYNX_ERP_READ_TOOL_IDS)[number];
export type LynxErpReadToolInput = z.infer<typeof lynxErpReadToolInputSchema>;
export type LynxErpReadToolOutput = z.infer<typeof lynxErpReadToolOutputSchema>;
