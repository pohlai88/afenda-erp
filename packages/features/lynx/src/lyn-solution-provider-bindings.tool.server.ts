...
import { createSolutionProviderTools } from "./lyn-solution-provider-tools.tool.server";
import type { ApiAuthContext } from "./lyn-api-auth.server";
...
export function createLynxSolutionProviderTools(
  auth: ApiAuthContext,
  model: string,
  options?: {
