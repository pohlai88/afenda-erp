...
import {
  ...
  type ActionSandbox,
  type ErpAssistantToolModule,
  type ErpAssistantToolOrganization,
  type ErpAssistantToolRecord,
  type ErpAssistantToolSession,
  type ErpAssistantToolWorkspace,
  type ErpAssistantToolWorkspaceStats,
  type GroundedEvidence,
} from "@afenda/ai/platform-tools";
import {
