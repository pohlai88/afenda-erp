import { appCapabilities, isAppCapability, type AppCapability } from "@afenda/auth";
...
export const systemAdminPermissionCatalog = appCapabilities.map((capability) => ({
  value: capability,
...
export const systemAdminApiScopes = [
  ...
  },
  {
    value: "erp.write",
    label: "ERP write",
    description: "Request tenant ERP mutations through approved command services.",
  },
  {
  ...
  },
  {
    ...
    description: "Read tenant control-plane state through approved API handlers.",
  },
  {
    value: "lynx.read",
    label: "Lynx read",
...
export type SystemAdminApiScope = (typeof systemAdminApiScopes)[number]["value"];
...
export function isSystemAdminApiScope(value: string): value is SystemAdminApiScope {
...
export function isSystemAdminPermissionKey(value: string): value is AppCapability {
