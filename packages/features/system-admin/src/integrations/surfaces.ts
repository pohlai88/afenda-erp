...
const API_KEY_COLUMNS = [
  { id: "label", header: "Label", priority: "primary" as const, pin: "start" as const },
...
const DELIVERY_COLUMNS = [
  { id: "eventType", header: "Event", priority: "primary" as const, pin: "start" as const },
  { id: "status", header: "Status", cellKind: { kind: "badge" as const } },
...
const SSO_COLUMNS = [
  { id: "provider", header: "Provider", priority: "primary" as const, pin: "start" as const },
...
export function buildApiCredentialsListSurface(input: {
  ...
  return buildGovernedListSurface({
    ...
    pagination: pagination(input.credentials.length),
    surface: {
...
export function buildWebhooksListSurface(input: {
  ...
  return buildGovernedListSurface({
    ...
    pagination: pagination(input.webhooks.length),
    surface: {
...
export function buildWebhookDeliveriesListSurface(input: {
  ...
  return buildGovernedListSurface({
    ...
    pagination: pagination(input.deliveries.length),
    surface: {
...
export function buildSsoConnectionsListSurface(input: {
  ...
  return buildGovernedListSurface({
    ...
    pagination: pagination(input.connections.length),
    surface: {
      ...
      empty: {
        variant: "muted",
        title: "No SSO connections configured (Neon Auth remains authoritative).",
      },
    },
    columns: SSO_COLUMNS,
