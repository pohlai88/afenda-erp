...
import type { SandboxExecutorResult } from "@afenda/ai/client";
...
function readSourceRecordId(
  ...
  const diff = sandbox.diff as { affectedRecords?: readonly string[] };
...
registerSandboxExecutor(
  "solution-action-proposal",
  executeRecoveryWorkItemSandbox,
);
