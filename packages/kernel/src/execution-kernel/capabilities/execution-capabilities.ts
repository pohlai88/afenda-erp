...
const routeByCapability: Partial<Record<AppCapability, `/${string}`>> = {
  ...
  "system-admin.settings.read": "/system-admin/settings",
  "system-admin.settings.write": "/system-admin/settings",
  ...
  "system-admin.machine-layer.read": "/system-admin/machine-layer",
  "system-admin.machine-layer.approve": "/system-admin/machine-layer",
