...
export const METADATA_UI_COMPONENT_REGISTRY = defineMetadataUiComponents([
  ...
  {
    id: "metadata-ui.section.multi-step-form",
    kind: "section",
    runtime: "server",
    label: "Multi-step form section",
    description: "Server section entry for metadata-driven multi-step forms.",
    capabilities: ["render", "compose", "interact", "submit", "navigate"],
    metadata: { sectionKind: "multi-step-form" },
  },
  {
    id: "metadata-ui.section.scorecard-form",
    kind: "section",
    runtime: "server",
    label: "Scorecard form section",
    description: "Server section entry for metadata-driven scorecard forms.",
    capabilities: ["render", "compose", "interact", "submit"],
    metadata: { sectionKind: "scorecard-form" },
  },
  {
  ...
  {
    id: "metadata-ui.section.approval-timeline",
    kind: "section",
    runtime: "server",
    label: "Approval timeline section",
    description: "Server section entry for metadata-driven approval timelines.",
    capabilities: ["render", "compose"],
    metadata: { sectionKind: "approval-timeline" },
  },
  {
  ...
  },
  {
    ...
    kind: "renderer",
    runtime: "server",
    label: "Multi-step form renderer",
    description: "Registered server renderer for multi-step-form sections.",
    capabilities: ["render"],
  ...
  },
  {
    ...
    kind: "renderer",
    runtime: "server",
    label: "Scorecard form renderer",
    description: "Registered server renderer for scorecard-form sections.",
    capabilities: ["render"],
  ...
  },
  {
    ...
    kind: "renderer",
    runtime: "server",
    label: "Approval timeline renderer",
    description: "Registered server renderer for approval-timeline sections.",
    capabilities: ["render"],
