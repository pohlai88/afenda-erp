...
import { R2_PRESIGN_EXPIRES_SECONDS } from "./r2-presign.shared";
...
export function createR2ObjectStore(r2: ObjectStorageR2Env): ObjectStorePort {
  ...
  return {
    ...
    async createPresignedUpload(
      ...
      // Cloudflare docs: restrict Content-Type in PutObjectCommand so mismatched
      // browser uploads fail with 403/SignatureDoesNotMatch. Size is enforced
      // on complete via HeadObject — do not sign Content-Length.
